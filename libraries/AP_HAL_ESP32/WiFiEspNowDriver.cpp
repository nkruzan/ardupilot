...
#include <AP_HAL_ESP32/WiFiEspNowDriver.h>
...
WiFiEspNowDriver::WiFiEspNowDriver()
{
    _state = NOT_INITIALIZED;
    accept_socket = -1;
}

void WiFiEspNowDriver::begin(uint32_t b)
{
    begin(b, 0, 0);
}

void WiFiEspNowDriver::begin(uint32_t b, uint16_t rxS, uint16_t txS)
{
    if (_state == NOT_INITIALIZED) {
        ...
        xTaskCreate(_wifi_thread, "APM_ESPNOW", Scheduler::WIFI_SS, this, Scheduler::WIFI_PRIO, &_wifi_task_handle);
...
void WiFiEspNowDriver::end()
{
    //TODO
}

void WiFiEspNowDriver::flush()
{
}

bool WiFiEspNowDriver::is_initialized()
{
    return true;
}

void WiFiEspNowDriver::set_blocking_writes(bool blocking)
{
    //blocking writes do not used anywhere
}

bool WiFiEspNowDriver::tx_pending()
{
    return (_writebuf.available() > 0);
}

uint32_t WiFiEspNowDriver::available()
{
    return _readbuf.available();
}

uint32_t WiFiEspNowDriver::txspace()
{
...
bool WiFiEspNowDriver::start_listen()
{
...
bool WiFiEspNowDriver::read_all()
{
...
bool WiFiEspNowDriver::write_data()
{
...
void WiFiEspNowDriver::_wifi_thread(void *arg)
{
//    WiFiEspNowDriver *self = (WiFiEspNowDriver *) arg;
//    while (true) {
//        struct timeval tv = {
//            .tv_sec = 0,
//            .tv_usec = 1000,
...
bool WiFiEspNowDriver::discard_input()
{
    return false;
}
