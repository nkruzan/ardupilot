...
#elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_ESP32_S2DEVKIT
#include "esp32s2devkit.h" //Nick K. on discord
...
#elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_ESP32_S3PERIPH
#include "esp32s3periph.h" 
#endif
